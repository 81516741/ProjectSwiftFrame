...
+ (void)configTabCToRootVC
{
    ...
    //模块A
    UIViewController * vcANavi = [[Mediator sharedInstance] home_getHomeController];
    if(vcANavi != nil) {
        [vcs addObject:vcANavi];
    }
    
    //模块B
    UINavigationController * vcBNavi = [[Mediator sharedInstance] me_getMeController];
    if(vcBNavi != nil) {
